...
public class Internal {
    ...
    public static final String BOOTANIMATION_LOCATION = References.isMagisk() ? References.MAGISK_MIRROR_MOUNT_POINT + "media/bootanimation.zip" : "/system/media/bootanimation.zip";
    public static final String BOOTANIMATION_BU = "bootanimation-backup.zip";
    public static final String BOOTANIMATION_BU_LOCATION = References.isMagisk() ? References.MAGISK_MIRROR_MOUNT_POINT + "media/bootanimation-backup.zip" : "/system/media/bootanimation-backup.zip";
