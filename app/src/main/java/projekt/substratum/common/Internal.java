...
public class Internal {
    ...
    public static final String BOOTANIMATION_LOCATION = References.getSystemDir() + "/media/bootanimation.zip";
    public static final String BOOTANIMATION_BU = "bootanimation-backup.zip";
    public static final String BOOTANIMATION_BU_LOCATION = References.getSystemDir() + "/media/bootanimation-backup.zip";
