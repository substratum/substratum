...
public class PackageError {
    ...
    public PackageError(String packageName) {
    ...
    public ArrayList<String> getBoolErrors() {
        return this.bools;
    }

    public ArrayList<String> getColorErrors() {
        return this.colors;
    }

    public ArrayList<String> getDimenErrors() {
        return this.dimens;
    }

    public ArrayList<String> getStyleErrors() {
        return this.styles;
    }
}