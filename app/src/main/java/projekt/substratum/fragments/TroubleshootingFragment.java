...
import projekt.substratum.adapters.TroubleShootAdapter;
...
public class TroubleshootingFragment extends Fragment {
    ...
    int[] troubleshootQuestions = {R.string.question_one,
    ...
    int[] troubleshootAnswers = {R.string.answer_one,
                                 R.string.answer_two,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle
        ...
        // make sure troubleshootQuestions & troubleshootAnswers are of same length and then assign adapter to listView
        troubleshootListView.setAdapter(new TroubleShootAdapter(troubleshootQuestions,troubleshootAnswers,getActivity().getApplicationContext()));
